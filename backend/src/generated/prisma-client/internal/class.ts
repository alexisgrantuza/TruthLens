...
/**
   ...
   * `prisma.imageVerification`: Exposes CRUD operations for the **ImageVerification** model.
    ...
    * ```
    */
  get imageVerification(): Prisma.ImageVerificationDelegate<ExtArgs, { omit: OmitOpts }>;
}
